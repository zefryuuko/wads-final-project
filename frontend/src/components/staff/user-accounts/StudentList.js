    ...
    render() {
        ...
        return (
            <div className="ease-on-load" style={this.state.isLoading ? this.loadingStyle : this.loadedStyle}>
                <PageWrapper>
                    <PageBreadcrumb title="Student Accounts" root="Account Administration" rightComponent={<Link className="btn btn-primary btn-circle mr-2" to="/staff/accounts/create" style={{padding:12}} ><i className="icon-plus"/></Link>}/>
                    <ContentWrapper>
                        <div className="row">
