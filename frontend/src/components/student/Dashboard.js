                        ...
                        <div class="card-group">
                                    ...
                                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                                        <div>
                                            <div class="d-inline-flex align-items-center">
                                                ...
                                                <span class="badge bg-danger font-12 text-white font-weight-medium badge-pill ml-2 d-lg-block d-md-none">Due today</span>
                                            </div>
                                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">New Assignments</h6>
                                        </div>
                            ...
                            <div class="card border-right">
                                <div class="card-body">
                                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                                        <div>
                                            <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium">3.92</h2>
                                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Grade Point Average
                                            </h6>
                                        </div>
                                        <div class="ml-auto mt-md-3 mt-lg-0">
                            ...
                            <div class="card border-right">
                                <div class="card-body">
                                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                                        <div>
                                            <div class="d-inline-flex align-items-center">
                                                <h2 class="text-dark mb-1 font-weight-medium">120</h2>
                                            </div>
                                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">SAT Points</h6>
                                        </div>
                                        <div class="ml-auto mt-md-3 mt-lg-0">
                                ...
                                <div class="card-body">
                                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                                        <div>
                                            ...
                                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Social Hours</h6>
                                        </div>
                                        <div class="ml-auto mt-md-3 mt-lg-0">
